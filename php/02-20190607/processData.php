...
<?php 
    $attributes = ["name", "email", "phone", "dob", "country"];
    for($i = 0; $i < count($data); $i++){?>
    <tr>
        <td><?php echo ($i + 1); ?></td>
        <td><?php echo $data[$i][$attributes[0]] ?></td>
        <td><?php echo $data[$i][$attributes[1]] ?></td>
        <td><?php echo $data[$i][$attributes[2]] ?></td>
        <td><?php echo $data[$i][$attributes[3]] ?></td>
        <td><?php echo $data[$i][$attributes[4]] ?></td>
    </tr>
   <?php } ?> 
</table>
</body>
